 ...
 * VideoItemOnlyNewOnlineDataSourceFactory.java is part of YaShlang.
 *
...
public class VideoItemOnlyNewOnlineDataSourceFactory extends DataSource.Factory<String, VideoItem> {
    ...
    public VideoItemOnlyNewOnlineDataSourceFactory(final Context context, final String playlistUrl,
    ...
    public DataSource<String, VideoItem> create() {
        return new VideoItemOnlyNewOnlineDataSource(context, playlistUrl, playlistId, loadThumbs, dataSourceListener);
    }
}
